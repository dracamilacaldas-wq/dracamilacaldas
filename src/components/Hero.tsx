    ...
    return (
        <section className="relative w-full min-h-[90vh] pt-32 pb-20 flex items-center bg-background overflow-hidden">
            <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
                ...
                {/* Mobile Visual (Visible only on small screens) - Moved after text/cta */}
                <motion.div
                    initial={{ opacity: 0, scale: 0.95 }}
                    whileInView={{ opacity: 1, scale: 1 }}
                    viewport={{ once: true }}
                    className="relative lg:hidden w-full aspect-[4/5] rounded-[2rem] overflow-hidden shadow-xl mt-6"
                >
                    <img
                        src="/image-hero.jpeg"
